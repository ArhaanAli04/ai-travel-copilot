...
import { X, Navigation, Star, Minimize2 } from 'lucide-react';
...
const userLocationIcon = L.divIcon({
  ...
  html: `
    <div style="
      ...
      border: 3px solid white;
      border-radius: 50%;
      box-shadow: 0 0 10px rgba(59, 130, 246, 0.5), 0 2px 5px rgba(0,0,0,0.3);
    "></div>
  `,
  iconSize: [20, 20],
  iconAnchor: [10, 10],
...
export const MapView: React.FC<MapViewProps> = ({
  ...
  return (
    // ✅ Changed: Side panel instead of modal
        ...
        >
          ...
          {pois.map((poi) => {
                ...
                return (
                    ...
                    eventHandlers={{
                        click: () => handleMarkerClick(poi.poi_id), // Scrolls to POI card
                    }}
                    >
                    ...
                    >
                        ...
                        <div className="font-semibold text-sm mb-1">{poi.name}</div>
                    ...
                    {/* ✅ Click Popup - Shows on click with full details */}
